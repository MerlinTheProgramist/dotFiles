...
- bashrc (lots of helpful bash commands)
- [alacritty](https://alacritty.org/) (terminal emulator)
- [helix](https://helix-editor.com/) (postmodern vim like text editor)
...
---
software that i use (adding special functions with the above suite):
- [starship](https://starship.rs/) (customizable prompt for any shell)
- [fzf](https://junegunn.github.io/fzf/) (fuzzy finder tool)
- [zathura](https://pwmt.org/projects/zathura/) (document viewer)
- [rofi](https://github.com/davatorium/rofi) (dmenu, calc, emoji)  
---
I use arch btw.
